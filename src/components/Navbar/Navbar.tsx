...
const portfolioSubItems: NavItem[] = [
  { label: "Casamento", href: "/ensaio-casamento" },
  { label: "Pré-Wedding", href: "/ensaio-pre-wedding" },
  { label: "Gestantes", href: "/ensaio-gestante" },
  { label: "Família", href: "/ensaio-familia" },
];
    ...
    <>
      ...
      >
        <div className="flex items-center gap-10">
          ...
          <a href="/depoimentos" className="desk-link">
            Depoimentos
          </a>
      ...
      <div className={`mobile-overlay md:hidden ${mobileOpen ? "open" : ""}`}>
        <div className="flex justify-between items-center px-6 py-4 bg-[var(--bege)] border-b border-[#ede5dc]">
